const selectors = {
    ...
    moves: document.querySelector('.timer'),
...
const shuffle = array => {
    ...
    for (let index = clonedArray.length - 1; index > 0;
    index--) {
...
const startGame = () => { state.gameStarted = true
...
setTimeout(() => {
    ...
    selectors.win.innerHTML = `<span class="win-text"> You won! <br/> with
    <span class="highlight">${state.totalFlips}</span> moves <br/> under
    <span class="highlight">${state.totalTime}</span> seconds </span>`
